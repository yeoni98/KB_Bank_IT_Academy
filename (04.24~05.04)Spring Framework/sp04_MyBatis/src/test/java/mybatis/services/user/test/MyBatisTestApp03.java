...
public class MyBatisTestApp03 {
	...
	public static void main(String[] args) throws Exception{
		...
		User user = new User("user04","1234","주몽",40,30);
		
		//1.User03.addUser Test
		
		  Object obj = session.insert("UserMapper03.addUser", user); session.commit();
		  //이 부분 반드시 해줘야 한다....mvc에서는 생략가능. //iBatis와 다르게 insert문의 리턴타입은 insert된 row수를
		 // 반환한다. 
